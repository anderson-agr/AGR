...
[assembly: ExportRenderer(typeof(MyVideoPlayer), typeof(AGR.Droid.MyVideoPlayerRenderer))]
namespace AGR.Droid
{
    public class MyVideoPlayerRenderer : ViewRenderer<MyVideoPlayer, Android.Widget.RelativeLayout>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<MyVideoPlayer> e)
        {
            ...
            if (this.Control == null)
            {
                ...
                this._MainLayout = (Android.Widget.RelativeLayout)layoutInflater.Inflate(AGR.Droid.Resource.Layout.VideoLayout, null);
                SetNativeControl(this._MainLayout);
            }

            this._MyVideoView = this.Control.FindViewById<MyVideoView>(AGR.Droid.Resource.Id.videoView1);
